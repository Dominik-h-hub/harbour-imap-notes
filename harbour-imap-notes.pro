...
# libetpan provides the IMAP protocol implementation. SFOS images ship a
# pkg-config file; fall back to a plain -letpan link when it isn't found
# so a stripped-down SDK target still builds.
